...
data = {
{
{text = 'Cɦᥲꪀꪀᥱᥣ S᥆ᥙrᥴᥱ', url = 't.me/SourceSuzy'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
*. Wᥱᥣᥴ᥆ꪔᥱ , Full By Source Suzy .  *
˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖˖
...
if text == (Redis:get(Thesuzyaes.."suzyaes:Name:Bot") or "بلاك بينك") then
local NamesBot = (Redis:get(Thesuzyaes.."suzyaes:Name:Bot") or "بلاك بينك")
local NameBots = {
"ها "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n˖ : أهلآ بك في بوت '..(Redis:get(Thesuzyaes.."suzyaes:Name:Bot") or "بلاك بينك")..
