...
{
{text = 'Dᥱ᥎ᥱᥣ᥆ρᥱr ᥆rძᥱr᥉', data = msg.sender.user_id..'/help5'}, {text = 'الالعاب', data = msg.sender.user_id..'/help6'}, 
},
{
...
˖ : ارسل { م2 } ← ᥲძꪔᎥꪀ᥉ ᥆rძᥱr᥉
˖ : ارسل { م3 } ← Mᥲꪀᥲgᥱr ᥆rძᥱr᥉
˖ : ارسل { م4 } ← Crᥱᥲƚ᥆r ᥆rძᥱr᥉
˖ : ارسل { م5 } ← Dᥱ᥎ᥱᥣ᥆ρᥱr ᥆rძᥱr᥉ البوت
*]],"md",false, false, false, false, reply_markup)
elseif text == 'م2' then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*˖ : هاذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
...
{
{text = 'Dᥱ᥎ᥱᥣ᥆ρᥱr ᥆rძᥱr᥉', data = IdUser..'/help5'}, {text = 'الالعاب', data = IdUser..'/help6'}, 
},
{
